...
import { API_KEY, imageUrl2 } from "../Constants/Constants";
  ...
  return (
    <div>
      ...
      <div className="flex justify-center mt-20 mb-8">
        ...
        <button
          onClick={Search}
          class="flex items-center px-8 text-white bg-primary -ml-2 focus:outline-none focus:ring-primary-300 transition ease-in-out font-medium rounded text-sm py-1 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
        >
          <svg
